...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Remove the Escape key event listener and replace with this inside the DOMContentLoaded event:
...
document.getElementById("btn-order").addEventListener("click", () => {
    ...
    axios.post("https://heybrewhideout.site/php/submit_order.php", {
        client_id: clientId,
